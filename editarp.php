...
if(isset($_POST['grabar']) && $_POST['grabar']=="si"){
    $pers->editarpers($_POST['id'], $_POST['nom'], $_POST['base']);
    exit();
}
$reg=$pers->get_ida($_GET['id']);
?>
<!doctype html>
<html lang="es">
                ...
                <form name="form" action="editarp.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nom" class="form-control" value="<?php echo $reg[0]['nombre'];?>">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <br>
                            <input type="button" class="btn btn-info" value="VOLVER" onclick="window.location='./menua.php'">
