    ...
    <div class="container">
        <div class="frame">
            ...
            <div id="recuperarContrasena" style="display:none;">
                <form style="padding-top: 0px !important;" class="form-signin" action="recuperar_contrasena.php" method="post" name="recoPassForm">
                    <label for="correo_recuperar">Ingrese su correo</label>
                    <input class="form-styling" type="email" name="correo_recuperar" placeholder="Digite su correo">
                    ...
                    type="submit" class="btn-signco" value="Enviar correo de recuperación" onclick="validarRecuperarContra(event)">
                </form>
            </div>
        </div>
    </div>
